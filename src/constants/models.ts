export interface AIModelInfo {
  ...
  apiModelId: string;
  name: string;
  provider: 'Gemini' | 'ChatGPT' | 'SpaceXAI' | 'Claude';
...
export const PROVIDER_LIST: Array<{
  ...
  name: 'Gemini' | 'ChatGPT' | 'SpaceXAI' | 'Claude';
  ...
  { id: 'spacexai', name: 'SpaceXAI', keyPlaceholder: 'SpaceXAI API Key (xai-...)' },
 ...
 *   gpt-5.6-sol (June 26 2026, 1.05M ctx) + gpt-6-astra (Sept 3 2026, 1.05M ctx).
  ...
  *   Company is SpaceXAI, product is Grok. API endpoint (api.x.ai) and key
  *   prefix (xai-...) unchanged as of Sept 2026 docs.
...
export const SUPPORTED_MODELS: AIModelInfo[] = [
  ...
  // Grok (SpaceXAI) — 500K context. API ID keeps the DOT.
  { id: 'grok-4.6', apiModelId: 'grok-4.6', name: 'Grok 4.6', provider: 'SpaceXAI', providerId: 'spacexai', contextWindow: 500_000, verifiedAsOf: '2026-09-06' },
