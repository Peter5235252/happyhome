/**
 * Happy Home - WebGPU High Performance Compute Shader Raytracer
 * Real-time Global Illumination, Volumetric Godrays, and Temporal Anti-Aliasing (TAA)
 */

export const getComputeShaderWGSL = (dynamicSDF: string = "", dynamicMats: string = "") => /* wgsl */ `
struct Uniforms {
  resolution: vec2f,
  aspect: f32,
  time: f32,
...
export const BLIT_SHADER_WGSL = /* wgsl */ `
struct VertexOutput {
